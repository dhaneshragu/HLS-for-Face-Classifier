...
void myproject_float(
    ...
    result_t layer20_out_ap[N_LAYER_19];

    myproject(conv2d_input_ap,layer20_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_19>(layer20_out_ap, layer20_out);
}

void myproject_double(
    double conv2d_input[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1],
    double layer20_out[N_LAYER_19]
) {
    input_t conv2d_input_ap[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1];
    ...
    nnet::convert_data<result_t, double, N_LAYER_19>(layer20_out_ap, layer20_out);
}
}
