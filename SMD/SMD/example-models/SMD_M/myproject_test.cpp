...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      result_t layer20_out[N_LAYER_19];
            ...
            myproject(conv2d_input,layer20_out);
            ...
            if (e % CHECKPOINT == 0) {
                ...
                nnet::print_result<result_t, N_LAYER_19>(layer20_out, std::cout, true);
            }
            e++;

            // hls-fpga-machine-learning insert tb-output
            nnet::print_result<result_t, N_LAYER_19>(layer20_out, fout);
        }
        fin.close();
        fpr.close();
    } else {
