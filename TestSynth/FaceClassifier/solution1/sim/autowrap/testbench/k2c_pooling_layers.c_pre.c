# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c"
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c" 2
# 10 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c"
...
#pragma pack(pop)
# 10 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c" 2
...
# 11 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c" 2
...
void k2c_batch_norm(k2c_tensor2* outputs, const k2c_tensor2* inputs, const k2c_tensor2* mean,
                    ...
                    const size_t axis);
# 12 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c" 2
# 22 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c"
...
# 47 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c"
...
# 69 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c"
...
# 94 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c"
...
# 129 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c"
void k2c_avgpool1d(k2c_tensor* output, const k2c_tensor* input, const size_t pool_size,
    ...
    for(size_t i=0; i<channels; ++i) {
        for (size_t j=0, k=0; j<output->numel; j+=channels, k+=stride*channels) {
            int count = 0;
            for (size_t l=0; l<pool_size*channels; l+=channels) {
                if (input->array[k+i+l] > -__builtin_huge_valf()) {
                    output->array[j+i] += input->array[k+i+l];
                    ++count;
                }
            }
...
# 157 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/C-Code-Original/include/k2c_pooling_layers.c"
        ...
        for (size_t j=0, k=0; j<output->shape[1]*channels;
            ...
            for (size_t l=0, m=0; l<output->numel; l+=channels*output->shape[1],
                ...
                for (size_t n=0; n<pool_size[1]*channels; n+=channels) {
                    for (size_t p=0; p<pool_size[0]*channels*input->shape[1];
                            p+=channels*input->shape[1]) {
                        if (-__builtin_huge_valf() < input->array[m+k+i+n+p]) {
                            output->array[l+j+i] += input->array[m+k+i+n+p];
                            ++count;
                        }
                    }
