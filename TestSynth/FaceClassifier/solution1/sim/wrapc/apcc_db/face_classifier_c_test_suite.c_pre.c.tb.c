...
printf("\n = %f\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = fpext float %%29 to double, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_86_count);
  llvm_cbe_tmp__28 = (double )((double )llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__28, *(long long*)(&llvm_cbe_tmp__28));
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([38 x i8]* @aesl_internal_.str1, i64 0, i64 0), double %%30) nounwind, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_87_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge4 = zext i1 %%32 to i32, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge4_count);
  llvm_cbe_storemerge4 = (unsigned int )((unsigned int )(bool )(llvm_fcmp_ogt(llvm_cbe_tmp__28, 0x1.999999999999ap-4))&1U);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%1 = getelementptr inbounds %%struct.k2c_tensor* %%tensor1, i64 0, i32 2, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_107_count);
  llvm_cbe_tmp__32 = (signed long long *)(&llvm_cbe_tensor1->field2);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__33);
  if (((llvm_cbe_tmp__33&18446744073709551615ULL) == (0ull&18446744073709551615ULL))) {
    ...
    llvm_cbe_tmp__34__PHI_TEMPORARY = (float )0x0p0;   /* for PHI node */
...
printf("\n  %%5 = getelementptr inbounds %%struct.k2c_tensor* %%tensor1, i64 0, i32 0, i64 %%storemerge1, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_112_count);
  llvm_cbe_tmp__35 = (float *)(&llvm_cbe_tensor1->field0[(((signed long long )llvm_cbe_storemerge1))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%7 = getelementptr inbounds %%struct.k2c_tensor* %%tensor2, i64 0, i32 0, i64 %%storemerge1, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_114_count);
  llvm_cbe_tmp__37 = (float *)(&llvm_cbe_tensor2->field0[(((signed long long )llvm_cbe_storemerge1))]);
if (AESL_DEBUG_TRACE) {
printf("\nstoremerge1 = 0x%I64X",((signed long long )llvm_cbe_storemerge1));
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%9 = fsub float %%6, %%8, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_116_count);
  llvm_cbe_tmp__39 = (float )((float )(llvm_cbe_tmp__36 - llvm_cbe_tmp__38));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%10 = tail call float @fabsf(float %%9) nounwind, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_117_count);
  llvm_cbe_tmp__40 = (float ) /*tail*/ fabsf(llvm_cbe_tmp__39);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%12 = select i1 %%11, float %%10, float %%4, !dbg !8 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_125_count);
  llvm_cbe_tmp__41 = (float )(((llvm_fcmp_ogt(llvm_cbe_tmp__40, llvm_cbe_tmp__34))) ? ((float )llvm_cbe_tmp__40) : ((float )llvm_cbe_tmp__34));
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__41, *(int*)(&llvm_cbe_tmp__41));
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = add i64 %%storemerge1, 1, !dbg !9 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_127_count);
  llvm_cbe_tmp__42 = (unsigned long long )((unsigned long long )(llvm_cbe_storemerge1&18446744073709551615ull)) + ((unsigned long long )(1ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%14 = load i64* %%1, align 8, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_133_count);
  llvm_cbe_tmp__43 = (unsigned long long )*llvm_cbe_tmp__32;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__43);
  if ((((unsigned long long )llvm_cbe_tmp__42&18446744073709551615ULL) < ((unsigned long long )llvm_cbe_tmp__43&18446744073709551615ULL))) {
    llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__42;   /* for PHI node */
    llvm_cbe_tmp__34__PHI_TEMPORARY = (float )llvm_cbe_tmp__41;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  } else {
    llvm_cbe__2e_lcssa__PHI_TEMPORARY = (float )llvm_cbe_tmp__41;   /* for PHI node */
    goto llvm_cbe__2e__crit_edge;
  }
