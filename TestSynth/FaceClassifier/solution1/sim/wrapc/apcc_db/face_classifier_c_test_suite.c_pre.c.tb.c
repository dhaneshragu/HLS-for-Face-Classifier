...
void AESL_WRAP_face_classifier_c(l_struct_OC_k2c_tensor , l_struct_OC_k2c_tensor *);
...
unsigned long long j __ATTRIBUTE_WEAK__;
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  store i64 1, i64* getelementptr inbounds (%%struct.k2c_tensor* @test1_dense_input_input, i64 0, i32 1), align 8, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1_count);
  *((&test1_dense_input_input.field1)) = 1ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 1ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 2622, i64* getelementptr inbounds (%%struct.k2c_tensor* @test1_dense_input_input, i64 0, i32 2), align 8, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_2_count);
  *((&test1_dense_input_input.field2)) = 2622ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 2622ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 2622, i64* getelementptr inbounds (%%struct.k2c_tensor* @test1_dense_input_input, i64 0, i32 3, i64 0), align 8, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_3_count);
  *((&test1_dense_input_input.field3[(((signed long long )0ull))])) = 2622ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 2622ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 1, i64* getelementptr inbounds (%%struct.k2c_tensor* @test1_dense_input_input, i64 0, i32 3, i64 1), align 8, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_4_count);
  *((&test1_dense_input_input.field3[(((signed long long )1ull))])) = 1ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 1ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 1, i64* getelementptr inbounds (%%struct.k2c_tensor* @test1_dense_input_input, i64 0, i32 3, i64 2), align 8, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_5_count);
...
printf("\n = 0x%I64X\n", 1ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 0, i64* @j, align 8, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_8_count);
  *(&j) = 0ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 0ull);
...
llvm_cbe_tmp__23:
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = phi i64 [ 0, %%0 ], [ %%6, %%1 ], !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_10_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds [2622 x float]* @aesl_internal_test1_dense_input_input_array, i64 0, i64 %%2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_11_count);
  llvm_cbe_tmp__2 = (float *)(&aesl_internal_test1_dense_input_input_array[(((signed long long )llvm_cbe_tmp__1))
#ifdef AESL_BC_SIM
 % 2622
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__1) < 2622)) fprintf(stderr, "%s:%d: warning: Read access out of array 'aesl_internal_test1_dense_input_input_array' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load float* %%3, align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_12_count);
  llvm_cbe_tmp__3 = (float )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__3, *(int*)(&llvm_cbe_tmp__3));
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds %%struct.k2c_tensor* @test1_dense_input_input, i64 0, i32 0, i64 %%2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_13_count);
  llvm_cbe_tmp__4 = (float *)(&test1_dense_input_input.field0[(((signed long long )llvm_cbe_tmp__1))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__1));
}
if (AESL_DEBUG_TRACE)
...
printf("\n = %f\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = add i64 %%2, 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_15_count);
  llvm_cbe_tmp__5 = (unsigned long long )((unsigned long long )(llvm_cbe_tmp__1&18446744073709551615ull)) + ((unsigned long long )(1ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__5&18446744073709551615ull)));
  if (((llvm_cbe_tmp__5&18446744073709551615ULL) == (2622ull&18446744073709551615ULL))) {
    goto llvm_cbe_tmp__24;
  } else {
    llvm_cbe_tmp__1__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__5;   /* for PHI node */
    goto llvm_cbe_tmp__23;
  }
...
llvm_cbe_tmp__24:
if (AESL_DEBUG_TRACE)
printf("\n  store float 0x3FCF750640000000, float* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 0, i64 0), align 8, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_17_count);
  *((&keras_activation_3_test1.field0[(((signed long long )0ull))])) = 0x1.f75064p-3;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", 0x1.f75064p-3);
if (AESL_DEBUG_TRACE)
printf("\n  store float 0x3FB214CFC0000000, float* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 0, i64 1), align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_18_count);
  *((&keras_activation_3_test1.field0[(((signed long long )1ull))])) = 0x1.214cfcp-4;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", 0x1.214cfcp-4);
if (AESL_DEBUG_TRACE)
printf("\n  store float 0x3F9BAB6F20000000, float* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 0, i64 2), align 8, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_19_count);
  *((&keras_activation_3_test1.field0[(((signed long long )2ull))])) = 0x1.bab6f2p-6;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", 0x1.bab6f2p-6);
if (AESL_DEBUG_TRACE)
printf("\n  store float 0x3FBD66C340000000, float* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 0, i64 3), align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_20_count);
  *((&keras_activation_3_test1.field0[(((signed long long )3ull))])) = 0x1.d66c34p-4;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", 0x1.d66c34p-4);
if (AESL_DEBUG_TRACE)
printf("\n  store float 0x3FE07D7900000000, float* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 0, i64 4), align 8, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_21_count);
  *((&keras_activation_3_test1.field0[(((signed long long )4ull))])) = 0x1.07d79p-1;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", 0x1.07d79p-1);
if (AESL_DEBUG_TRACE)
printf("\n  store float 0x3F9B0EF800000000, float* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 0, i64 5), align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_22_count);
  *((&keras_activation_3_test1.field0[(((signed long long )5ull))])) = 0x1.b0ef8p-6;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", 0x1.b0ef8p-6);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 1, i64* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 1), align 8, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_23_count);
  *((&keras_activation_3_test1.field1)) = 1ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 1ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 6, i64* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 2), align 8, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
  *((&keras_activation_3_test1.field2)) = 6ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 6ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 6, i64* getelementptr inbounds (%%struct.k2c_tensor* @keras_activation_3_test1, i64 0, i32 3, i64 0), align 8, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_25_count);
...
printf("\n = 0x%I64X\n", 1ull);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load float* getelementptr inbounds ([6 x float]* @c_activation_3_test1_array, i64 0, i64 0), align 16, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__6 = (float )*((&c_activation_3_test1_array[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 6
#endif
]));
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%8, float* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 0, i64 0), align 8, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_31_count);
  *((&c_activation_3_test1.field0[(((signed long long )0ull))])) = llvm_cbe_tmp__6;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load float* getelementptr inbounds ([6 x float]* @c_activation_3_test1_array, i64 0, i64 1), align 4, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__7 = (float )*((&c_activation_3_test1_array[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 6
#endif
]));
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%9, float* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 0, i64 1), align 4, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_33_count);
  *((&c_activation_3_test1.field0[(((signed long long )1ull))])) = llvm_cbe_tmp__7;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load float* getelementptr inbounds ([6 x float]* @c_activation_3_test1_array, i64 0, i64 2), align 8, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__8 = (float )*((&c_activation_3_test1_array[(((signed long long )2ull))
#ifdef AESL_BC_SIM
 % 6
#endif
]));
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%10, float* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 0, i64 2), align 8, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_35_count);
  *((&c_activation_3_test1.field0[(((signed long long )2ull))])) = llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = load float* getelementptr inbounds ([6 x float]* @c_activation_3_test1_array, i64 0, i64 3), align 4, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__9 = (float )*((&c_activation_3_test1_array[(((signed long long )3ull))
#ifdef AESL_BC_SIM
 % 6
#endif
]));
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%11, float* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 0, i64 3), align 4, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_37_count);
  *((&c_activation_3_test1.field0[(((signed long long )3ull))])) = llvm_cbe_tmp__9;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load float* getelementptr inbounds ([6 x float]* @c_activation_3_test1_array, i64 0, i64 4), align 16, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__10 = (float )*((&c_activation_3_test1_array[(((signed long long )4ull))
#ifdef AESL_BC_SIM
 % 6
#endif
]));
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%12, float* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 0, i64 4), align 8, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_39_count);
  *((&c_activation_3_test1.field0[(((signed long long )4ull))])) = llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = load float* getelementptr inbounds ([6 x float]* @c_activation_3_test1_array, i64 0, i64 5), align 4, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_40_count);
  llvm_cbe_tmp__11 = (float )*((&c_activation_3_test1_array[(((signed long long )5ull))
#ifdef AESL_BC_SIM
 % 6
#endif
]));
...
if (AESL_DEBUG_TRACE)
printf("\n  store float %%13, float* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 0, i64 5), align 4, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_41_count);
  *((&c_activation_3_test1.field0[(((signed long long )5ull))])) = llvm_cbe_tmp__11;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 6, i64* @j, align 8, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_42_count);
  *(&j) = 6ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 6ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 1, i64* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 1), align 8, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_43_count);
  *((&c_activation_3_test1.field1)) = 1ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 1ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 6, i64* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 2), align 8, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_44_count);
  *((&c_activation_3_test1.field2)) = 6ull;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", 6ull);
if (AESL_DEBUG_TRACE)
printf("\n  store i64 6, i64* getelementptr inbounds (%%struct.k2c_tensor* @c_activation_3_test1, i64 0, i32 3, i64 0), align 8, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_45_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = tail call i32 @clock() nounwind, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_55_count);
  llvm_cbe_tmp__12 = (unsigned int ) /*tail*/ clock();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__12);
}
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @AESL_WRAP_face_classifier_c(%%struct.k2c_tensor* byval @test1_dense_input_input, %%struct.k2c_tensor* @c_activation_3_test1) nounwind, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_58_count);
   /*tail*/ AESL_WRAP_face_classifier_c(test1_dense_input_input, (l_struct_OC_k2c_tensor *)(&c_activation_3_test1));
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = tail call i32 @clock() nounwind, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_59_count);
  llvm_cbe_tmp__13 = (unsigned int ) /*tail*/ clock();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__13);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = sitofp i32 %%15 to double, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
  llvm_cbe_tmp__14 = (double )((double )(signed int )llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__14, *(long long*)(&llvm_cbe_tmp__14));
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = sitofp i32 %%14 to double, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_63_count);
  llvm_cbe_tmp__15 = (double )((double )(signed int )llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__15, *(long long*)(&llvm_cbe_tmp__15));
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = fsub double %%16, %%17, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_64_count);
  llvm_cbe_tmp__16 = (double )llvm_cbe_tmp__14 - llvm_cbe_tmp__15;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__16, *(long long*)(&llvm_cbe_tmp__16));
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = fdiv double %%18, 1.000000e+03, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_65_count);
  llvm_cbe_tmp__17 = (double )llvm_cbe_tmp__16 / 0x1.f4p9;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__17, *(long long*)(&llvm_cbe_tmp__17));
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = fdiv double %%19, 1.000000e+01, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_66_count);
  llvm_cbe_tmp__18 = (double )llvm_cbe_tmp__17 / 0x1.4p3;
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__18, *(long long*)(&llvm_cbe_tmp__18));
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([34 x i8]* @aesl_internal_.str, i64 0, i64 0), double %%20) nounwind, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_67_count);
...
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %lf,  0x%llx",llvm_cbe_tmp__18, *(long long*)(&llvm_cbe_tmp__18));
printf("\nReturn  = 0x%X",llvm_cbe_tmp__19);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = tail call float @maxabs(%%struct.k2c_tensor* @keras_activation_3_test1, %%struct.k2c_tensor* @c_activation_3_test1), !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_68_count);
  llvm_cbe_tmp__20 = (float ) /*tail*/ maxabs((l_struct_OC_k2c_tensor *)(&keras_activation_3_test1), (l_struct_OC_k2c_tensor *)(&c_activation_3_test1));
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = %f",llvm_cbe_tmp__20);
}
if (AESL_DEBUG_TRACE)
printf("\n  store float %%22, float* getelementptr inbounds ([10 x float]* @errors, i64 0, i64 0), align 16, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_69_count);
...
printf("\n = %f\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = fpext float %%22 to double, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_79_count);
  llvm_cbe_tmp__21 = (double )((double )llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__21, *(long long*)(&llvm_cbe_tmp__21));
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([38 x i8]* @aesl_internal_.str1, i64 0, i64 0), double %%23) nounwind, !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_80_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge4 = zext i1 %%25 to i32, !dbg !13 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge4_count);
  llvm_cbe_storemerge4 = (unsigned int )((unsigned int )(bool )(llvm_fcmp_ogt(llvm_cbe_tmp__21, 0x1.4f8b588e368f1p-17))&1U);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%1 = getelementptr inbounds %%struct.k2c_tensor* %%tensor1, i64 0, i32 2, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_100_count);
  llvm_cbe_tmp__25 = (signed long long *)(&llvm_cbe_tensor1->field2);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = load i64* %%1, align 8, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_101_count);
  llvm_cbe_tmp__26 = (unsigned long long )*llvm_cbe_tmp__25;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__26);
  if (((llvm_cbe_tmp__26&18446744073709551615ULL) == (0ull&18446744073709551615ULL))) {
...
printf("\n  %%5 = getelementptr inbounds %%struct.k2c_tensor* %%tensor1, i64 0, i32 0, i64 %%storemerge1, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_105_count);
  llvm_cbe_tmp__28 = (float *)(&llvm_cbe_tensor1->field0[(((signed long long )llvm_cbe_storemerge1))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%7 = getelementptr inbounds %%struct.k2c_tensor* %%tensor2, i64 0, i32 0, i64 %%storemerge1, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_107_count);
  llvm_cbe_tmp__30 = (float *)(&llvm_cbe_tensor2->field0[(((signed long long )llvm_cbe_storemerge1))]);
if (AESL_DEBUG_TRACE) {
printf("\nstoremerge1 = 0x%I64X",((signed long long )llvm_cbe_storemerge1));
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%9 = fsub float %%6, %%8, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_109_count);
  llvm_cbe_tmp__32 = (float )((float )(llvm_cbe_tmp__29 - llvm_cbe_tmp__31));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%10 = tail call float @fabsf(float %%9) nounwind, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_110_count);
  llvm_cbe_tmp__33 = (float ) /*tail*/ fabsf(llvm_cbe_tmp__32);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = %f,  0x%x",llvm_cbe_tmp__32, *(int*)(&llvm_cbe_tmp__32));
printf("\nReturn  = %f",llvm_cbe_tmp__33);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = select i1 %%11, float %%10, float %%4, !dbg !8 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_118_count);
  llvm_cbe_tmp__34 = (float )(((llvm_fcmp_ogt(llvm_cbe_tmp__33, llvm_cbe_tmp__27))) ? ((float )llvm_cbe_tmp__33) : ((float )llvm_cbe_tmp__27));
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__34, *(int*)(&llvm_cbe_tmp__34));
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = add i64 %%storemerge1, 1, !dbg !9 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_120_count);
  llvm_cbe_tmp__35 = (unsigned long long )((unsigned long long )(llvm_cbe_storemerge1&18446744073709551615ull)) + ((unsigned long long )(1ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%14 = load i64* %%1, align 8, !dbg !7 for 0x%I64xth hint within @maxabs  --> \n", ++aesl_llvm_cbe_126_count);
  llvm_cbe_tmp__36 = (unsigned long long )*llvm_cbe_tmp__25;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__36);
  if ((((unsigned long long )llvm_cbe_tmp__35&18446744073709551615ULL) < ((unsigned long long )llvm_cbe_tmp__36&18446744073709551615ULL))) {
    llvm_cbe_storemerge1__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__35;   /* for PHI node */
    llvm_cbe_tmp__27__PHI_TEMPORARY = (float )llvm_cbe_tmp__34;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  } else {
    llvm_cbe__2e_lcssa__PHI_TEMPORARY = (float )llvm_cbe_tmp__34;   /* for PHI node */
    goto llvm_cbe__2e__crit_edge;
  }
