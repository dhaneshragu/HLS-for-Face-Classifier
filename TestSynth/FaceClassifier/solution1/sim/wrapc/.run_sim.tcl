...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "face_classifier_c.autotvin.dat"
	set constFileTvOut       "face_classifier_c.autotvout.dat"
	set constFileHdlTvIn     "face_classifier_c.autohdltvin.dat"
	set constFileHdlTvOut    "face_classifier_c.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
