...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.face_classifier_c.autotvin_dense_input_input_array.dat"
         "c.face_classifier_c.autotvin_dense_input_input_ndim.dat"
         "c.face_classifier_c.autotvin_dense_input_input_numel.dat"
         "c.face_classifier_c.autotvin_dense_input_input_shape.dat"
         "c.face_classifier_c.autotvin_activation_3_output_array.dat"
         "c.face_classifier_c.autotvin_activation_3_output_shape.dat"
         "c.face_classifier_c.autotvout_activation_3_output_array.dat"
         "c.face_classifier_c.autotvout_activation_3_output_ndim.dat"
         "c.face_classifier_c.autotvout_activation_3_output_numel.dat"
         "c.face_classifier_c.autotvout_activation_3_output_shape.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.face_classifier_c.autotvout_activation_3_output_array.dat"
         "rtl.face_classifier_c.autotvout_activation_3_output_ndim.dat"
         "rtl.face_classifier_c.autotvout_activation_3_output_numel.dat"
         "rtl.face_classifier_c.autotvout_activation_3_output_shape.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
