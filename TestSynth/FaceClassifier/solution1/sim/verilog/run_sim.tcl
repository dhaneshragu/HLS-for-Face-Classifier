...
if {[file isfile face_classifier_c.autotvin.dat]} {
	file delete -force face_classifier_c.autotvin.dat
}

if {[file isfile face_classifier_c.autotvout.dat]} {
	file delete -force face_classifier_c.autotvout.dat
}
