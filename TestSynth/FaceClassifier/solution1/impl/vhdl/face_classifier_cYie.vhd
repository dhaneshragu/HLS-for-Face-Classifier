...
entity face_classifier_cYie_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 60
...
architecture rtl of face_classifier_cYie_rom is 
...
entity face_classifier_cYie is
    generic (
...
architecture arch of face_classifier_cYie is
    component face_classifier_cYie_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    face_classifier_cYie_rom_U :  component face_classifier_cYie_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
