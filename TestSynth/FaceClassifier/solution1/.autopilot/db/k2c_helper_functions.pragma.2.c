# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_helper_functions.pragma.1.c"
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_helper_functions.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_helper_functions.pragma.1.c" 2
# 1 "../C-Code-Original/include/k2c_helper_functions.c"
# 1 "../C-Code-Original/include/k2c_helper_functions.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "../C-Code-Original/include/k2c_helper_functions.c" 2
...
#pragma pack(pop)
# 9 "../C-Code-Original/include/k2c_helper_functions.c" 2
...
# 10 "../C-Code-Original/include/k2c_helper_functions.c" 2
...
# 11 "../C-Code-Original/include/k2c_helper_functions.c" 2
...
# 12 "../C-Code-Original/include/k2c_helper_functions.c" 2

# 1 "../C-Code-Original/include/k2c_include.h" 1
# 12 "../C-Code-Original/include/k2c_include.h"
...
# 54 "../C-Code-Original/include/k2c_helper_functions.c"
void k2c_affine_matmul(float C[100000], const float A[100000],
  const float B[100000], const float d[100000], const size_t outrows,
  const size_t outcols, const size_t innerdim) {_ssdm_SpecArrayDimSize(C, 100000);_ssdm_SpecArrayDimSize(A, 100000);_ssdm_SpecArrayDimSize(B, 100000);_ssdm_SpecArrayDimSize(d, 100000);
...
# 82 "../C-Code-Original/include/k2c_helper_functions.c"
size_t k2c_sub2idx(const size_t * sub, const size_t * shape, const size_t ndim) {
...
# 108 "../C-Code-Original/include/k2c_helper_functions.c"
...
# 276 "../C-Code-Original/include/k2c_helper_functions.c"
...
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 ...
 for (i = 0; i < B->numel; ++i) {
_ssdm_op_SpecLoopTripCount(1, 2622, 1311, "");
...
# 620 "../C-Code-Original/include/k2c_helper_functions.c"
...
# 816 "../C-Code-Original/include/k2c_helper_functions.c"
void k2c_bias_add(k2c_tensor2* A, const k2c_tensor2* b) {
...
# 837 "../C-Code-Original/include/k2c_helper_functions.c"
...
# 876 "../C-Code-Original/include/k2c_helper_functions.c"
