# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_recurrent_layers.pragma.1.c"
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_recurrent_layers.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_recurrent_layers.pragma.1.c" 2
# 1 "../C-Code-Original/include/k2c_recurrent_layers.c"
# 1 "../C-Code-Original/include/k2c_recurrent_layers.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "../C-Code-Original/include/k2c_recurrent_layers.c" 2
...
#pragma pack(pop)
# 10 "../C-Code-Original/include/k2c_recurrent_layers.c" 2
...
# 11 "../C-Code-Original/include/k2c_recurrent_layers.c" 2
...
void k2c_gru(k2c_tensor* output, const k2c_tensor* input, float * state,
             ...
             k2c_activationType *recurrent_activation,
             k2c_activationType *output_activation);
# 12 "../C-Code-Original/include/k2c_recurrent_layers.c" 2
# 27 "../C-Code-Original/include/k2c_recurrent_layers.c"
void k2c_lstmcell(float * state, const float * input, const k2c_tensor* kernel,
                  const k2c_tensor* recurrent_kernel, const k2c_tensor* bias, float * fwork,
                  k2c_activationType *recurrent_activation,
                  k2c_activationType *output_activation) {
...
# 121 "../C-Code-Original/include/k2c_recurrent_layers.c"
void k2c_lstm(k2c_tensor* output, const k2c_tensor* input, float * state,
              const k2c_tensor* kernel, const k2c_tensor* recurrent_kernel,
              const k2c_tensor* bias, float * fwork, const int go_backwards,
              const int return_sequences, k2c_activationType *recurrent_activation,
...
# 173 "../C-Code-Original/include/k2c_recurrent_layers.c"
void k2c_simpleRNNcell(float * state, const float * input, const k2c_tensor* kernel,
                       const k2c_tensor* recurrent_kernel, const k2c_tensor* bias,
                       float * fwork, k2c_activationType *output_activation) {
...
# 211 "../C-Code-Original/include/k2c_recurrent_layers.c"
void k2c_simpleRNN(k2c_tensor* output, const k2c_tensor* input, float * state,
                   const k2c_tensor* kernel, const k2c_tensor* recurrent_kernel,
                   const k2c_tensor* bias, float * fwork, const int go_backwards,
                   const int return_sequences, k2c_activationType *output_activation) {
...
# 264 "../C-Code-Original/include/k2c_recurrent_layers.c"
void k2c_grucell(float * state, const float * input, const k2c_tensor* kernel,
                 const k2c_tensor* recurrent_kernel, const k2c_tensor* bias, float * fwork,
                 const int reset_after, k2c_activationType *recurrent_activation,
                 k2c_activationType *output_activation) {
...
# 365 "../C-Code-Original/include/k2c_recurrent_layers.c"
void k2c_gru(k2c_tensor* output, const k2c_tensor* input, float * state,
             const k2c_tensor* kernel, const k2c_tensor* recurrent_kernel,
             const k2c_tensor* bias, float * fwork, const int reset_after,
             const int go_backwards, const int return_sequences,
