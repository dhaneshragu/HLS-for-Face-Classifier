...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Ar_shape \
    op interface \
    ports { Ar_shape_address0 { O 3 vector } Ar_shape_ce0 { O 1 bit } Ar_shape_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'Ar_shape'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B_array \
    op interface \
    ports { B_array_address0 { O 19 vector } B_array_ce0 { O 1 bit } B_array_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fwork \
    op interface \
    ports { fwork_address0 { O 19 vector } fwork_ce0 { O 1 bit } fwork_we0 { O 1 bit } fwork_d0 { O 32 vector } fwork_q0 { I 32 vector } fwork_address1 { O 19 vector } fwork_ce1 { O 1 bit } fwork_q1 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_Ar_ndim_read \
    op interface \
    ports { Ar_ndim_read { I 64 vector } } \
} "
}
