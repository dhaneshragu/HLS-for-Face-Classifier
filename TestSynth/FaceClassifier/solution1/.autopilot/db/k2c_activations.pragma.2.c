# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_activations.pragma.1.c"
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_activations.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_activations.pragma.1.c" 2
# 1 "../C-Code-Original/include/k2c_activations.c"
# 1 "../C-Code-Original/include/k2c_activations.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "../C-Code-Original/include/k2c_activations.c" 2
# 10 "../C-Code-Original/include/k2c_activations.c"
...
#pragma pack(pop)
# 10 "../C-Code-Original/include/k2c_activations.c" 2
...
# 11 "../C-Code-Original/include/k2c_activations.c" 2
...
void k2c_batch_norm(k2c_tensor2* outputs, const k2c_tensor2* inputs, const k2c_tensor2* mean,
                    ...
                    const size_t axis);
# 12 "../C-Code-Original/include/k2c_activations.c" 2
# 22 "../C-Code-Original/include/k2c_activations.c"
void k2c_linear_func(float * x, const size_t size) {

}
k2c_activationType * k2c_linear = k2c_linear_func;
# 35 "../C-Code-Original/include/k2c_activations.c"
void k2c_exponential_func(float * x, const size_t size) {
...
# 51 "../C-Code-Original/include/k2c_activations.c"
void k2c_relu_func(float * x, const size_t size) {
...
# 71 "../C-Code-Original/include/k2c_activations.c"
void k2c_hard_sigmoid_func(float * x, const size_t size) {
...
# 95 "../C-Code-Original/include/k2c_activations.c"
void k2c_tanh_func(float * x, const size_t size) {
    for (size_t i=0; i<size; ++i) {
        x[i] = tanhf(x[i]);
    }
...
# 110 "../C-Code-Original/include/k2c_activations.c"
void k2c_sigmoid_func(float * x, const size_t size) {
...
# 127 "../C-Code-Original/include/k2c_activations.c"
void k2c_softmax_func(float x[6], const size_t size) {_ssdm_SpecArrayDimSize(x, 6);
...
# 162 "../C-Code-Original/include/k2c_activations.c"
void k2c_softplus_func(float * x, const size_t size) {
...
# 178 "../C-Code-Original/include/k2c_activations.c"
void k2c_softsign_func(float * x, const size_t size) {
...
# 197 "../C-Code-Original/include/k2c_activations.c"
...
# 218 "../C-Code-Original/include/k2c_activations.c"
...
# 237 "../C-Code-Original/include/k2c_activations.c"
...
# 256 "../C-Code-Original/include/k2c_activations.c"
...
# 277 "../C-Code-Original/include/k2c_activations.c"
