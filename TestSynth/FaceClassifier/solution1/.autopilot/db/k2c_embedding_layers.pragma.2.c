# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_embedding_layers.pragma.1.c"
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_embedding_layers.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "C:/Users/ketan/Desktop/college/CS-577-Course-Project/TestSynth/FaceClassifier/solution1/.autopilot/db/k2c_embedding_layers.pragma.1.c" 2
# 1 "../C-Code-Original/include/k2c_embedding_layers.c"
# 1 "../C-Code-Original/include/k2c_embedding_layers.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "../C-Code-Original/include/k2c_embedding_layers.c" 2
...
#pragma pack(pop)
# 9 "../C-Code-Original/include/k2c_embedding_layers.c" 2
...
# 10 "../C-Code-Original/include/k2c_embedding_layers.c" 2
...
void k2c_batch_norm(k2c_tensor* outputs, const k2c_tensor* inputs, const k2c_tensor* mean,
                    ...
                    const size_t axis);
# 11 "../C-Code-Original/include/k2c_embedding_layers.c" 2
# 22 "../C-Code-Original/include/k2c_embedding_layers.c"
