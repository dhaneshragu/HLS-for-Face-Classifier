...
#ifndef __face_classifier_cxdS__HH__
#define __face_classifier_cxdS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(face_classifier_cxdS) {
    ...
    SC_CTOR(face_classifier_cxdS):  simcore_mac_2_U ("simcore_mac_2_U") {
