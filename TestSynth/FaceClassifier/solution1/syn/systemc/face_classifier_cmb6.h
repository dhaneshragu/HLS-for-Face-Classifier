...
#ifndef __face_classifier_cmb6__HH__
#define __face_classifier_cmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(face_classifier_cmb6) {
    ...
    SC_CTOR(face_classifier_cmb6):  simcore_mac_0_U ("simcore_mac_0_U") {
