...
#ifndef __face_classifier_cdEe__HH__
#define __face_classifier_cdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(face_classifier_cdEe) {
    ...
    SC_CTOR(face_classifier_cdEe):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
