...
#ifndef __face_classifier_cZio_H__
#define __face_classifier_cZio_H__
...
struct face_classifier_cZio_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(face_classifier_cZio_ram) {
...
SC_MODULE(face_classifier_cZio) {
...
face_classifier_cZio_ram* meminst;


SC_CTOR(face_classifier_cZio) {
meminst = new face_classifier_cZio_ram("face_classifier_cZio_ram");
