...
#ifndef __face_classifier_c8jQ_H__
#define __face_classifier_c8jQ_H__
...
SC_MODULE(face_classifier_c8jQ) {
...
face_classifier_c8jQ_ram* meminst;


SC_CTOR(face_classifier_c8jQ) {
meminst = new face_classifier_c8jQ_ram("face_classifier_c8jQ_ram");
