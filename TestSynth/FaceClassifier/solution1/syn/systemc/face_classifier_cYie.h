...
#ifndef __face_classifier_cYie_H__
#define __face_classifier_cYie_H__
...
struct face_classifier_cYie_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(face_classifier_cYie_ram) {
...
SC_MODULE(face_classifier_cYie) {
...
face_classifier_cYie_ram* meminst;


SC_CTOR(face_classifier_cYie) {
meminst = new face_classifier_cYie_ram("face_classifier_cYie_ram");
